...
<form class="space-y-8">
    ...
    <div class="flex flex-wrap justify-between items-center gap-4" data-aos="fade-up">
        <div>
            ...
            <p class="text-sm text-[var(--admin-text-secondary)] mt-1">Fill out the form below to publish a new article.</p>
        </div>
        <div class="flex items-center gap-4">
            <button type="button" class="px-4 py-2 bg-white border border-[var(--admin-border)] text-sm font-semibold rounded-md hover:bg-gray-50">Save as Draft</button>
        ...
        <div class="lg:col-span-2 space-y-8">
            <div class="admin-card" data-aos="fade-up" data-aos-delay="100">
                <div class="p-6 settings-form">
                    ...
                    <input type="text" class="form-input text-lg" placeholder="e.g., The History of Coffee Beans" />
                </div>
            </div>
